...
const StyledButton = styled.button`
  color: white;
  background-color: ${props => props.altStyle ? 'darkred' : 'green'};
  font: inherit;
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <StyledButton altStyle={this.state.showPersons} onClick={this.togglePersonsHandler}>Toggle Persons</StyledButton>
        { persons }
      </div>
    );
  }
